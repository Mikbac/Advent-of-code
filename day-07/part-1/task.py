...
def get_type(card_stats):
	...
	# 6 - Five of a kind
	if len(card_stats_sorted) >= 1 and len(card_stats_sorted[0]) == 5:
		return 6

	# 5 - Four of a kind
	if len(card_stats_sorted) >= 1 and len(card_stats_sorted[0]) == 4:
		return 5

	# 4 - Full house
	if len(card_stats_sorted) >= 2 and (len(card_stats_sorted[0]) + len(card_stats_sorted[1])) == 5:
		return 4
	...
	# 3 - Three of a kind
	if len(card_stats_sorted) >= 1 and len(card_stats_sorted[0]) == 3:
		return 3

	# 2 - Two pair
	if len(card_stats_sorted) >= 2 and len(card_stats_sorted[0]) + len(card_stats_sorted[1]) == 4:
		return 2
